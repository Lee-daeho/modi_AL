...
class LossNet(nn.Module):
    def __init__(self, feature_sizes=[32, 16, 8, 4], num_channels=[64, 128, 256, 512], interm_dim=128, base_model='resnet'):
        super(LossNet, self).__init__()

        self.base_model = base_model
        
        self.GAP1 = nn.AvgPool2d(feature_sizes[0])  #B * 64 * 1
        self.GAP2 = nn.AvgPool2d(feature_sizes[1])  #B * 128 * 1
        self.GAP3 = nn.AvgPool2d(feature_sizes[2])  #B * 256 * 1
        self.GAP4 = nn.AvgPool2d(feature_sizes[3])  #B * 512 * 1
